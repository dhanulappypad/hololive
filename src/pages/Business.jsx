          ...
          <div className="row">
            <div className="col-md-12">
              <ul className="va_breadcrumb">
                ...
                <li>Business Consultants & Analysts</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-md-9 col-12">
              <div className="service_name">
                <h1>Business Consultants & Analysts</h1>
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="box-part text-center">
                      ...
                      <div class="text">
                        <span>
                          Help you determine the most advantageous form of
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="box-part text-center">
                      ...
                      <div class="text">
                        <span>
                          Address the complex issues of business continuation
                          and can assist you in developing a strategically sound
                          plan
                        </span>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="box-part text-center">
                      ...
                      <div class="text">
                        <span>
                          Provides security for your surviving spouse, and can
